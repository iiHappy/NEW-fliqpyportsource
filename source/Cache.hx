...
class Cache extends MusicBeatState
{
	...
	override function create()
	{
		...
		var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('tittlestuff/flippytitle-' + FlxG.random.int(1, 4)));
		menuBG.screenCenter();
		add(menuBG);
		...
		shitz = new FlxText(12, 12, 0, "Preloading Assets...", 12);
	...
	function cache()
	{
		...
		#end
		FlxG.switchState(new DaMessage());
	}
