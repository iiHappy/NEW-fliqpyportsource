...
class CharSelectState extends MusicBeatState{
    var charsArray:Array<String> = ['BF', 'BF-CAR', "BF-MINUS", "BF-CRINGEHAND"];
    var leBG:FlxSprite;
    var bf:FlxSprite;
    var bfcar:FlxSprite;
    var bfminus:FlxSprite;
    var bfedited:FlxSprite;
    ...
    override function create(){
        ...
        add(bfcar);
        bfminus = new FlxSprite(450, 300).loadGraphic(Paths.image('characters/BoyFriend_Assets'));
        bfminus.frames = Paths.getSparrowAtlas('characters/BoyFriend_Assets');
        bfminus.animation.addByPrefix('idle', 'BF idle dance', 24, true);
        bfminus.animation.addByPrefix('hey', 'BF HEY!!', 24, true);
        bfminus.animation.play('idle');
        add(bfminus); 
        bfedited = new FlxSprite(450, 300).loadGraphic(Paths.image('characters/BF_Edited_Assets'));
        bfedited.frames = Paths.getSparrowAtlas('characters/BF_Edited_Assets');
        bfedited.animation.addByPrefix('idle', 'BF idle dance', 24, true);
        bfedited.animation.addByPrefix('hey', 'BF HEY!!', 24, true);
        bfedited.animation.play('idle');
        add(bfedited);  
    ...
    function changeSelection(change:Int = 0) {
       ...
       case 0:
        bf.visible = true;
        bfcar.visible = false;
        bfminus.visible = false;
        bfedited.visible = false;
        ...
        case 2:
            bf.visible = false;
            bfcar.visible = false;
            bfminus.visible = true;
            bfedited.visible = false;
            FlxTween.color(leBG, 2, leBG.color, FlxColor.WHITE, {onComplete:function(twn:FlxTween){
            FlxTween.cancelTweensOf(leBG);
        }});
        case 3:
            bf.visible = false;
    ...
    override function update(elapsed:Float){
        ...
        switch(curSelected){
        case 3:
        FlxFlicker.flicker(bfedited, 1.5, 0.15, false);
        bfedited.animation.play('hey');
        case 2:
        FlxFlicker.flicker(bfminus, 1.5, 0.15, false);
        bfminus.animation.play('hey');
        case 1:
