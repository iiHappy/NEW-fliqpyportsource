...
class FlippyExtras extends MusicBeatState{
	...
	{
		addSong('traumatized', 1, 'fliqpy', FlxColor.GREEN);
		addSong('massacre-recharted', 2, 'fliqpy', FlxColor.GREEN);
		...
		scoreText.setFormat(Paths.font("htf.ttf"), 32, FlxColor.WHITE, RIGHT);
		...
		text.setFormat(Paths.font("htf.ttf"), size, FlxColor.WHITE, RIGHT);
